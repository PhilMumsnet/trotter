<div class="border-black-400 border-b-2 p-2">
    ...
    <div class="flex">
        <div class="flex items-center">
            <svg wire:click="like" viewBox="0 0 20 20" class="text-green-400 h-5" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="ml-1">{{ $trott->likes }}</span>
        </div>
        <div class="flex items-center ml-2">
            <svg wire:click="dislike" viewBox="0 0 20 20" class="text-green-400 h-5" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="ml-1">{{ $trott->dislikes }}</span>
        </div>
    </div>
</div>
